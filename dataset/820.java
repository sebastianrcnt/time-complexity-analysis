...
public class CF903F {
  ...
  static void fill(int[][][][] aa, int a) {
    for (int h0 = 0; h0 <= 4; h0++)
      for (int h1 = 0; h1 <= 4; h1++)
        for (int h2 = 0; h2 <= 4; h2++) for (int h3 = 0; h3 <= 4; h3++) aa[h0][h1][h2][h3] = a;
  }
  ...
  public static void main(String[] args) throws IOException {
    ...
    for (int k = 0; k < 4; k++) {
      ...
      c_[0] = c_[1] = c_[2] = c_[3] = c_[n + 4] = c_[n + 5] = c_[n + 6] = c_[n + 7] = '.';
    }
          ...
          for (int h2 = 0; h2 <= 4; h2++)
            for (int h3 = 0; h3 <= 4; h3++)
              for (int s = 0; s < 10; s++) {
                ...
                if (dp[hh[0]][hh[1]][hh[2]][hh[3]] > x) dp[hh[0]][hh[1]][hh[2]][hh[3]] = x;
              }
      fill(dq, INF);
        ...
        for (int h1 = 1; h1 <= 4; h1++) {
          ...
          for (int h2 = 1; h2 <= 4; h2++) {
            ...
            for (int h3 = 1; h3 <= 4; h3++) {
              ...
              if (dq[hh[0]][hh[1]][hh[2]][hh[3]] > x) dq[hh[0]][hh[1]][hh[2]][hh[3]] = x;
            }
          }
        }
      }
