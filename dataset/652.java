...
public class Main {
  ...
  static class TaskG {
    ...
    public static void dfs2(int i, int parE) {
      if (i == 0) {
        ...
        dpPathToRootWithDetours[i] =
            dpPathToRootWithDetours[par] - Math.max(0, dp[i] - edges[parE][2] * 2);
    ...
    public void solve(int testNumber, InputReader in, PrintWriter out) {
      ...
      dfs(0, -1);
      dfs2(0, -1);
      GraphLowestCommonAncestor.LCA lca =
          GraphLowestCommonAncestor.createLCA(appearance, firstAppearance, depth);
      ...
      for (int i = 0; i < q; i++) {
        ...
        long res =
            dpPathToRootWithDetours[u]
                ...
                - 2 * dpPathToRootWithDetours[lcaI]
                + dp[lcaI];
        out.println(res);
      }
    }
  ...
  static class MinRangeSparseTable implements ISearchInRange {
    ...
    public Pair<Long, Long> queryIndexValueInRange(long l, long r) {
      ...
      int res =
          min(sparseTables[LCAIndex][(int) l], sparseTables[LCAIndex][(int) (r - sizeNeeded + 1)]);
  ...
  static class GraphLowestCommonAncestor {
    public static GraphLowestCommonAncestor.LCA createLCA(
        int[] appearances, final int[] firstAppearance, final int[] depth) {
      return new GraphLowestCommonAncestor.LCA_MinRangeSparseTable(
          appearances, firstAppearance, depth);
    }
