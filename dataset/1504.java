 ...
 * than or equal to x, and the floor is the greatest element smaller than or equal to x. Assume than
 * the array is sorted in non-decreasing order. Write efficient functions to find floor and ceiling
 * of x.
 *
 * <p>For example, let the input array be {1, 2, 8, 10, 10, 12, 19} For x = 0:floor doesn't exist in
 * array, ceil = 1 For x = 1: floor = 1, ceil = 1 For x = 5: floor = 2, ceil = 8 For x = 20: floor=
 * 19, ceil doesn't exist in array
 *
 * @author ajitkoti
 */
public class FloorAndCeilingInASortedArray {
   ...
   * reduces time complexity to O(Logn).
   *
   * @param arr
   * @param low
   * @param high
